...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Dave has looked after my cars over the years with his incredible facilities and attention to detail. A recent job he did on my Tanzanite Blue BMW has transformed the car completely. You wouldn’t believe it's an 8 year old car! Highly recommend if you want the best job doing.",
    name: "HABBO FOXX",
  },
